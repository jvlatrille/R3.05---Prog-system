...
int participants = 0;       // Compteur des participants arrivés
int totalParticipants;            // Nombre total de participants
...
void* participant(void* arg) {
    ...
    if (participants == totalParticipants) {
        ...
        while (participants < totalParticipants) {
...
int main() {
    ...
    pthread_t threads[totalParticipants]; // Tableau pour stocker les threads
